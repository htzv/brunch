...
[`docs/examples/templates/`](https://github.com/htzv/brunch/tree/main/docs/examples/templates/); copy any of them into your
...
See [`docs/examples/templates/README.md`](https://github.com/htzv/brunch/blob/main/docs/examples/templates/README.md) for
...
- **Original prompt**: [`DESIGN.md`](https://github.com/htzv/brunch/blob/main/DESIGN.md) — the conversation that
  started the project, kept for provenance.
- **Example templates**: [`docs/examples/templates/`](https://github.com/htzv/brunch/tree/main/docs/examples/templates/).
